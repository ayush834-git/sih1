...
export default function Loader({
  ...
  return (
    <div
      className={cn(
        "flex flex-col items-center justify-center gap-8 p-8 dark",
        className
      )}
      {...props}
    >
      ...
      >
        ...
        <motion.div
          ...
          style={{
            background:
              "conic-gradient(from 0deg, transparent 0deg, rgb(255, 214, 10) 90deg, transparent 180deg)",
        ...
        <motion.div
          ...
          style={{
            background:
              "conic-gradient(from 270deg, transparent 0deg, rgba(255, 214, 10, 0.4) 20deg, transparent 40deg)",
      ...
      >
        ...
        <motion.h1
          ...
          className={cn(
            config.titleClass,
            "font-mono text-white leading-[1.15] tracking-widest uppercase antialiased"
          )}
          initial={{ opacity: 0, y: 12 }}
          transition={{
            delay: 0.6,
        ...
        <motion.p
          ...
          className={cn(
            ...
            "font-mono text-[#707070] leading-[1.45] tracking-wider uppercase antialiased"
          )}
